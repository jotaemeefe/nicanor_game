...
| Ventilador de techo — 4 frames | `assets/props/ventilador/ventilador_1..4.png` + `fan_frames.tres` | `nuevos_assets/ambient/ceiling_fan_4_frames.png` | Clean alpha. Ambient loop with irregular per-frame durations (1.3/0.8/1.6/1.0s), replacing the static painted fan for this element. |
